      ...
      <box>
        <For each={players}>
          {(player) => {
            ...
            // Fixed: Check if 'app' exists before trying to access its properties
            // to prevent a crash if no matching app is found.
            return <image visible={!!app} iconName={app?.iconName} />
          }}
        </For>
      </box>
      <popover>
